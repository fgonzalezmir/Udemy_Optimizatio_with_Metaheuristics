...
#Se pone el +1 para añadir el fitness value
...
for i in range(Runs):
    ...
    #Obtine todas las combinaciones que se obtiene a partir de X0 cambiando dos elementos cada vez.
    List_of_N = list(itr.combinations(X0, 2)) # From X0, it shows how many combinations of 2's can it get; 8 choose 2
    # List_of_N nos da todas las combinaciones de dos elementos que tiene X0 -> 28 combinaciones
    
    Counter_for_N = 0
    
    All_N_for_i = np.empty((0,len(X0)))
    
    # El vecindario será todas las soluciones a partir de X0 que se producen intercambiando 2 elementos.
    ...
    for i in List_of_N:
        ...
        # Buscamos vecinos intercambiando 2 elementos.
        u= 0
        ...
        #Almacenamos todo el vecindario --> 28 vecinos
    ...
    # Ordered OF of neighborhood, sorted by OF value. Ordenado de mejor a peor.
    ...
    #Si la solución 0 está en la tabu list cogemos la siguiente solución
    ...
    # salimos del vecindario para evitar minimos locales y vamos a otras regiones.

    # Cada 10 iteraciones, creamos 3 numeros aleatorios.
    ...
    # Cada 10 iteraciones hacemos un swaping de tres departmentos. Para salirnos de las soluciones
    # obtenidas en el vecindario. Así inercambando 3 nos salimos del vecindario.
    if Mod_Iterations == 0:
        Xt = []
